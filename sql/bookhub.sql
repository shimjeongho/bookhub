...
CREATE TABLE "BOOKHUB_POSTS" (
	...
	"BOOK_NO"	NUMBER(6)   NULL,
	"LIB_NO"	NUMBER(6)		 NULL,
...
CREATE TABLE "BOOKHUB_USERS" (
    ...
    "USER_PHONE"          VARCHAR2(100 BYTE) NOT NULL,
    ...
    "USER_ROLE"           VARCHAR2(10 CHAR) DEFAULT 'USER' NOT NULL
);
...
CREATE TABLE "BOOKHUB_LOAN_HISTORIES" (
	...
	"LOAN_STATUS"	CHAR(1)	DEFAULT 'L'	NULL,
	"USER_ID"	VARCHAR2(255)		NOT NULL,
	"LIB_NO"	NUMBER(6)		NOT NULL,
	"BOOK_NO"	NUMBER(6)		NOT NULL,
	"IS_EXTENSION"	CHAR(1)	DEFAULT 'N'	NULL
);
...
CREATE TABLE "BOOKHUB_BOOKS" (
   ...
   "BOOK_REVIEW_AVG"   NUMBER(2,1)   DEFAULT 0   NULL,
...
CREATE TABLE "BOOKHUB_ADDRESS" (
	...
	"ADDR_CREATED_DATE"	DATE	DEFAULT SYSDATE NULL,
...
--13. 기증 도서 태이블 
CREATE TABLE "BOOKHUB_DONATION_BOOKS" (
   "DONATION_NO"   NUMBER(6)      NOT NULL,
   "DONATION_BOOK_TITLE"   VARCHAR2(400)      NOT NULL,
   "DONATION_BOOK_AUTHOR"   VARCHAR2(255)      NOT NULL,
   "DONATION_BOOK_PUBLISHER"   VARCHAR2(255)      NOT NULL,
   "DONATION_BOOK_DESCRIPTION"   VARCHAR2(2000)      NULL,
   "DONATION_CREATED_DATE"   DATE   DEFAULT SYSDATE   NULL,
   "DONATION_UPDATED_DATE"   DATE   DEFAULT SYSDATE    NULL,
   "IS_DELETED"   CHAR(1)   DEFAULT 'N'   NULL,
   "USER_ID"   VARCHAR2(255)      NOT NULL,
   "LIB_NO"   NUMBER(6)      NOT NULL
);
...
--14. 게시글 댓글 테이블 
CREATE TABLE "BOOKHUB_POST_REPLIES" (
    "REPLY_NO"                NUMBER(6),                 
    "PARENT_NO"               NUMBER(6) NULL,            
...
--DONATION_BOOKS
ALTER TABLE "BOOKHUB_DONATION_BOOKS" ADD CONSTRAINT "PK_BOOKHUB_DONATION_BOOKS" PRIMARY KEY (
   "DONATION_NO"
);

--POST_REPLIES
ALTER TABLE "BOOKHUB_POST_REPLIES"
ADD CONSTRAINT "PK_BOOKHUB_POST_REPLIES" PRIMARY KEY ("REPLY_NO");
...
-- DONATION_BOOKS
ALTER TABLE "BOOKHUB_DONATION_BOOKS" ADD CONSTRAINT "FK_BOOKHUB_USERS_TO_BOOKHUB_DONATION_BOOKS_1" FOREIGN KEY (
   "USER_ID"
)
REFERENCES "BOOKHUB_USERS" (
   "USER_ID"
...
ALTER TABLE "BOOKHUB_DONATION_BOOKS" ADD CONSTRAINT "FK_BOOKHUB_LIBRARIES_TO_BOOKHUB_DONATION_BOOKS_1" FOREIGN KEY (
   "LIB_NO"
)
REFERENCES "BOOKHUB_LIBRARIES" (
   "LIB_NO"
...
-- POST_REPLIES
ALTER TABLE "BOOKHUB_POST_REPLIES"
ADD CONSTRAINT "FK_BOOKHUB_USERS_TO_BOOKHUB_POST_REPLIES_1"
FOREIGN KEY ("USER_ID")
REFERENCES "BOOKHUB_USERS"("USER_ID");

ALTER TABLE "BOOKHUB_POST_REPLIES"
ADD CONSTRAINT "FK_BOOKHUB_POSTS_TO_BOOKHUB_POST_REPLIES_1"
FOREIGN KEY ("POST_NO")
REFERENCES "BOOKHUB_POSTS"("POST_NO");

ALTER TABLE "BOOKHUB_POST_REPLIES"
ADD CONSTRAINT "FK_BOOKHUB_POST_REPLIES_TO_BOOKHUB_POST_REPLIES_2"
FOREIGN KEY ("PARENT_NO")
REFERENCES "BOOKHUB_POST_REPLIES"("REPLY_NO");
...
ALTER TABLE BOOKHUB_LOAN_HISTORIES
ADD CONSTRAINT CHK_BOOKHUB_LOAN_HISTORIES_IS_EXTENSION
CHECK (IS_EXTENSION IN ('Y', 'N'));

-- DOANTION_BOOKS
ALTER TABLE BOOKHUB_DONATION_BOOKS
ADD CONSTRAINT CHK_BOOKHUB_DONATION_BOOKS_IS_DELETED
CHECK (IS_DELETED IN ('Y', 'N'));

-- POST_REPLIES
ALTER TABLE BOOKHUB_POST_REPLIES
ADD CONSTRAINT CHK_REPLIES_ISDELETED
CHECK (IS_DELETED IN ('Y', 'N'));
COMMIT;
-------------------------CHECK 제약조건 설정------------------------------
...
-- DONATION_BOOKS
CREATE SEQUENCE BOOKHUB_DONATION_BOOKS_DONATION_NO_SEQ START WITH 1;

-- POST_REPLIES
CREATE SEQUENCE BOOKHUB_POST_REPLIES_REPLY_NO_SEQ START WITH 1;
