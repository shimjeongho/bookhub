...
<%
	...
	int totalRowsParentReply = mapper.getTotalRows(condition);
	                                ...
	                                <div class="d-flex justify-content-between mb-2">
	                                   <!-- 사용자 이름 및 작성일자.--> 
	                                    <div>
	                                        ...
	                                        <span class="text-muted ms-2"><%=StringUtils.simpleDate(parentReply.getUpdatedDate()) %></span>
	                                    </div>
...
%>  
						...
						<button type="button"
                                ...
                                data-post-no="<%=postNo %>"
                                data-page-no="<%=currentPageNo %>">더보기</button>                  
		                                ...
		                                <div class="d-flex justify-content-between mb-2">
		                                   <!-- 사용자 이름 및 작성일자.--> 
		                                    <div>
		                                        ...
		                                        <span class="text-muted ms-2">\${parentReply.updatedDate}</span>
		                                    </div>
						                    ...
						                    <div class="\${parentReply.isDeleted === 'Y' ? 'd-none' : ''}">
		                                        ...
		                                        <a class="btn btn-sm btn-link text-danger reply_del_btn"
